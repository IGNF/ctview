...
mnx_dtm.tile_geometry.tile_coord_scale=1 \
mnx_dtm.tile_geometry.tile_width=50 \
mnx_dtm.buffer.size=10 \
mnx_dsm.tile_geometry.tile_coord_scale=1 \
mnx_dsm.tile_geometry.tile_width=50 \
mnx_dsm.buffer.size=10 \
mnx_dtm_dens.tile_geometry.tile_coord_scale=1 \
mnx_dtm_dens.tile_geometry.tile_width=50 \
mnx_dtm_dens.buffer.size=10 \