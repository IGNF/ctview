...
from ctview.map_DTM_DSM import color_raster_dtm_hillshade_with_LUT
...
# expected
expected_dtm_color_1cycle_file = os.path.join(
    tmp_path, "DTM", "color", "1cycle", "test_data_77055_627760_LA93_IGN69_DTM_hillshade_color1c.tif"
)
expected_dtm_color_5cycles_file = os.path.join(
    tmp_path, "DTM", "color", "5cycles", "test_data_77055_627760_LA93_IGN69_DTM_hillshade_color5c.tif"
)
...
def test_color_raster_dtm_hillshade_with_LUT():
    ...
    color_raster_dtm_hillshade_with_LUT(
        input_initial_basename=input_tilename,
