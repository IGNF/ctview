...
expected_dir_5 = os.path.join(output_dir, "DSM")
expected_dir_6 = os.path.join(output_dir, "tmp_dsm", "filter")
expected_dir_7 = os.path.join(output_dir, "tmp_dsm", "buffer")
expected_dir_8 = os.path.join(output_dir, "tmp_dsm", "hillshade")
expected_dir_9 = os.path.join(output_dir, "DTM_DENS")
expected_dir_10 = os.path.join(output_dir, "tmp_dtm_dens", "filter")
expected_dir_11 = os.path.join(output_dir, "tmp_dtm_dens", "buffer")
expected_dir_12 = os.path.join(output_dir, "tmp_dtm_dens", "hillshade")
