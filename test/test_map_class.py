...
from ctview.map_class import step1_create_raster_brut, step2_create_raster_fillgap
...
def test_step1_create_raster_brut():
    raster = step1_create_raster_brut(in_points=IN_POINTS,output_dir=TEST_DIR, filename=FILENAME, res=1)
...
def test_step2_create_raster_fillgap():
    raster_brut = step1_create_raster_brut(in_points=IN_POINTS,output_dir=TEST_DIR, filename=FILENAME, res=1)
    raster_fillgap = step2_create_raster_fillgap(in_raster=raster_brut, output_dir=TEST_DIR, filename=FILENAME)
