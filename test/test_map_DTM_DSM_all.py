...
def test_create_mnx_one_las():
    ...
    output_raster = create_mnx_one_las(
        input_file=input_filename, output_dir=output_dir, config_dict=config_dict, type_raster="dtm"
    )
...
def test_create_dtm_with_hillshade_one_las_5M_pixelsize():
    ...
    Verify :
        ...
        - output is the raster hillshaded
    """
    output_raster = create_dtm_with_hillshade_one_las_5M(input_file=input_filename, output_dir=output_dir_3)
...
def test_create_dtm_with_hillshade_one_las_1M_pixelsize():
    ...
    Verify :
        ...
        - output is the raster hillshaded
    """
    output_raster = create_dtm_with_hillshade_one_las_1M(input_file=input_filename, output_dir=output_dir_3)
...
def test_create_dsm_with_hillshade_one_las_50CM_pixelsize():
    ...
    Verify :
        ...
        - output is the raster hillshaded
    """
    output_raster = create_dsm_with_hillshade_one_las_50CM(input_file=input_filename, output_dir=output_dir_3)
